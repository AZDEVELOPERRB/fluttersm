...
class _VpanelState extends State<RegisterPanel> {
    ...
    return Scaffold(
      ...
      body: Container(
        child:connection==true?Stack(
          children:<Widget> [
            WebView(
              initialUrl: '${RoyalBoardConfig.RoyalBoardAppUrl}register',
        onWebResourceError:  (error) {
          setState(() {
            ...
            WebviewScaffold(
              url: '${RoyalBoardConfig.RoyalBoardAppUrl}register',
              appBar: new AppBar(
                title: Text('انشاء متجر جديد',style: TextStyle(color: Colors.blue),),
                actions: [
                  InkWell(
                      onTap:(){
