...
import 'package:RoyalBoard_Common_sooq/Offers/productlistfilterwithoffers.dart';

class ProductListOfOffers extends StatefulWidget {
  const ProductListOfOffers(
...
class _ProductListWithFilterContainerViewState
    extends State<ProductListOfOffers>
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: ProductListWithFilterWithOffers(
          animationController: animationController,
