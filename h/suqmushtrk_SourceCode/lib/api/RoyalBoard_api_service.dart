...
import 'package:RoyalBoard_Common_sooq/viewobject/download_product.dart';
...
import 'common/RoyalBoard_api.dart';
import 'common/RoyalBoard_resource.dart';

class RoyalBoardApiService extends RoyalBoardApi {
  ///
  /// App Info
  ///
  ...
  Future<PsResource<List<Shop>>> getShopList(
    ...
    final String url =
        '${PsUrl.ps_shop_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/limit/$limit/offset/$offset';



    return await postData<Shop, List<Shop>>(Shop(), url, paramMap);
  }
  Future<PsResource<List<Shop>>> getShopListforcats(
      Map<dynamic, dynamic> paramMap, int limit, int offset) async {
    final String url =
        '${PsUrl.shops_of_cats_shop_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/limit/$limit/offset/$offset';
  ...
  Future<PsResource<ApiStatus>> postUafromrolletapi(
      Map<dynamic, dynamic> jsonMap) async {
    const String url = '${PsUrl.ps_postua}';
    return await postData<ApiStatus, ApiStatus>(ApiStatus(), url, jsonMap);
  }
  ...
  Future<PsResource<List<User>>> getUser(String userId) async {
    final String url =
        '${PsUrl.ps_user_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/user_id/$userId';
  ...
  Future<PsResource<List<ShippingArea>>> getShippingArea(String shopId) async {
    final String url =
        '${PsUrl.ps_shipping_area_url}/shop_id/$shopId/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}';
  ...
  Future<PsResource<ShippingArea>> getShippingAreaById(
    ...
    final String url =
        '${PsUrl.ps_shipping_area_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/id/$shippingId';
  ...
  Future<PsResource<List<Category>>> getCategoryList(
    ...
    final String url =
        '${PsUrl.ps_category_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<AboutApp>>> getAboutAppDataList() async {
    const String url =
        '${PsUrl.ps_about_app_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/';
  ...
  Future<PsResource<List<Category>>> getAllCategoryList(
      Map<dynamic, dynamic> jsonMap) async {
    const String url =
        '${PsUrl.ps_category_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}';
  ...
  Future<PsResource<List<SubCategory>>> getSubCategoryList(
    ...
    final String url =
        '${PsUrl.ps_subCategory_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/limit/$limit/offset/$offset/cat_id/$categoryId';
  ...
  Future<PsResource<List<SubCategory>>> getAllSubCategoryList(
    ...
    final String url =
        '${PsUrl.ps_subCategory_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/cat_id/$categoryId${shopid!=null?"/shop_id/$shopid/isubcat/true":""}';
    print('fhdfhsdffghdfhsghaghdsfh${url}');
  ...
  Future<PsResource<List<Noti>>> getNotificationList(
      Map<dynamic, dynamic> paramMap, int limit, int offset) async {
    final String url =
        '${PsUrl.ps_noti_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<Product>>> getProductList(
      Map<dynamic, dynamic> paramMap, int limit, int offset) async {
    final String url =
        '${PsUrl.ps_product_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/limit/$limit/offset/$offset';
    print('dsfglsdjggadglfsgasfgasfafkdsjg${url}${paramMap}');
  ...
  Future<PsResource<Product>> getProductDetail(
    ...
    final String url =
        '${PsUrl.ps_product_detail_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/id/$productId/login_user_id/$loginUserId';
  ...
  Future<PsResource<List<Product>>> getRelatedProductList(
    ...
    final String url =
        '${PsUrl.ps_relatedProduct_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/id/$productId/cat_id/$categoryId/limit/$limit/offset/$offset';
    print(url);
  ...
  Future<PsResource<List<ProductCollectionHeader>>> getProductCollectionList(
    ...
    final String url =
        '${PsUrl.ps_collection_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/limit/$limit/offset/$offset';
   ...
   Future<PsResource<List<ProductCollectionHeader>>> getProductCollectionListByShopId(
    ...
    final String url =
        '${PsUrl.ps_collection_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/limit/$limit/offset/$offset/shop_id/$shopId';
  ...
  Future<PsResource<ShopInfo>> getShopInfo(String shopId) async {
    final String url =
        '${PsUrl.ps_shop_info_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/id/$shopId';
  ...
  Future<PsResource<List<Blog>>> getBlogList(int limit, int offset) async {
    final String url =
        '${PsUrl.ps_bloglist_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<Blog>>> getBlogListByShopId(
      String shopId, int limit, int offset) async {
    final String url =
        '${PsUrl.ps_bloglist_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/limit/$limit/offset/$offset/shop_id/$shopId';
  ...
  Future<PsResource<List<TransactionHeader>>> getTransactionList(
    ...
    final String url =
        '${PsUrl.ps_transactionList_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/user_id/$userId/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<TransactionDetail>>> getTransactionDetail(
    ...
    final String url =
        '${PsUrl.ps_transactionDetail_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/transactions_header_id/$id/limit/$limit/offset/$offset';
    print(url);
  ...
  Future<PsResource<List<TransactionStatus>>> getTransactionStatusList() async {
    const String url =
        '${PsUrl.ps_transactionStatus_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}';
  ...
  Future<PsResource<List<CommentHeader>>> getCommentList(
    ...
    final String url =
        '${PsUrl.ps_commentList_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/product_id/$productId/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<CommentDetail>>> getCommentDetail(
    ...
    final String url =
        '${PsUrl.ps_commentDetail_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/header_id/$headerId/limit/$limit/offset/$offset';
  ...
  Future<PsResource<CommentHeader>> getCommentHeaderById(
    ...
    final String url =
        '${PsUrl.ps_commentList_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/id/$commentId';
  ...
  Future<PsResource<List<Product>>> getFavouritesList(
    ...
    final String url =
        '${PsUrl.ps_favouriteList_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/login_user_id/$loginUserId/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<Product>>> getProductListByCollectionId(
    ...
    final String url =
        '${PsUrl.ps_all_collection_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/id/$collectionId/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<Rating>>> getRatingList(
      String productId, int limit, int offset) async {
    final String url =
        '${PsUrl.ps_ratingList_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/product_id/$productId/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<ShopRating>>> getShopRatingList(
      String shopId, int limit, int offset) async {
    final String url =
        '${PsUrl.ps_shop_ratinglist_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/shop_id/$shopId/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<Product>>> getFavouriteList(
      String loginUserId, int limit, int offset) async {
    final String url =
        '${PsUrl.ps_ratingList_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/login_user_id/$loginUserId/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<DefaultPhoto>>> getImageList(
      ...
      int offset) async {
    final String url =
        '${PsUrl.ps_gallery_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}/img_parent_id/$parentImgId/limit/$limit/offset/$offset';
  ...
  Future<PsResource<ApiStatus>> getToken() async {
    const String url = '${PsUrl.ps_token_url}/api_key/${RoyalBoardConfig.RoyalBoardServerLanucher}';
