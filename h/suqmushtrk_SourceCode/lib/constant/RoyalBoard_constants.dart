...
class RoyalBoardConst {
  ...
  static const String RoyalBoard_filter = 'showed_number'; // Don't Change
  ...
  static const String FILTERING_TRENDING_offer = 'offer_rate';
  ...
  static const int REQUEST_CODE__MENU_HOME_point = 10101;
  static const int REQUEST_CODE__MENU_LATEST_PRODUCT_FRAGMENT = 1006;
  static const int rollet_game = 13246548;
  static const int afrad_section = 13246541656548;
  static const int dynamic_link_progress = 3549287914;
  static const int friends_core = 44656548;
  static const int friends_send_request = 4224224218;
  static const int friends_applied = 34254168792;
  static const int markets_categories = 5769134;
  static const int REQUEST_CODE__MENU_vendors_FRAGMENT = 1021021;
  static const int REQUEST_CODE__MENU_mufrad = 694764897646;
  static const int REQUEST_CODE__MENU_search = 24681487968;
  ...
  static const int App_Info = 1054651352413;
  ...
  static const int REQUEST_CODE__MENU_bloglist = 104524526548678516;
  static const int REQUEST_CODE__MENU_TRANSACTION_FRAGMENT = 1017;
  static const int firm_prices_gifts = 106841828417;
  ...
  static final NumberFormat psFormat = NumberFormat(RoyalBoardConfig.priceFormat);
  ...
  ///Admob Setting
  ///
  static const bool SHOW_ADMOB = false;
 ...
 static List<String> mohav=[
  ...
  static const String defaultEmail = 'admin@roy-board.com';
  static const String defaultPassword = 'admin@roy-board.com';
...
static  RoyalBoardToast(String msg,bool suc){
   Fluttertoast.showToast(msg: msg,backgroundColor: suc==true?Colors.green:Colors.red);
  }
}
