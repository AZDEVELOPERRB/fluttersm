...
class Single_product_from_url extends StatefulWidget {
  const Single_product_from_url(
      {Key key,
...
class _ProductListWithFilterViewState extends State<Single_product_from_url>
