...
import 'package:RoyalBoard_Common_sooq/from_url/Single_product.dart';
...
import 'Single_product_friends.dart';

class ProductList_from_Friends extends StatefulWidget {
  const ProductList_from_Friends(
      {@required this.productParameterHolder, @required this.appBarTitle,@required this.prod_id});
...
class _ProductListWithFilterContainerViewState
    extends State<ProductList_from_Friends>
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Single_product_from_Friends(
          animationController: animationController,
