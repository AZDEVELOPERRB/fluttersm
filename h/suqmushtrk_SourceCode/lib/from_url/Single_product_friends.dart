...
class Single_product_from_Friends extends StatefulWidget {
  const Single_product_from_Friends(
      {Key key,
...
class _ProductListWithFilterViewState extends State<Single_product_from_Friends>
                                  ...
                                  SliverGrid(
                                    ...
                                    delegate: SliverChildBuilderDelegate(
                                        ...
                                        if (provider.productList.data != null ||
                                          ...
                                          if( provider.productList.data[index].id==widget.prod_id) {
