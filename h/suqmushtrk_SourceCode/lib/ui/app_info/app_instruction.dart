...
import 'package:RoyalBoard_Common_sooq/provider/about_app/about_app_provider.dart';
...
class AppInstructionView extends StatefulWidget {
  @override
...
class _AppInfoViewState extends State<AppInstructionView>
  ...
  Widget build(BuildContext context) {
    ...
    return  WillPopScope(
      onWillPop: (){},
      child: PsWidgetWithAppBar<AboutAppProvider>(
          appBarTitle:'',
          initProvider: () {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                     ...
                     Image.asset('assets/images/flutter_grocery_logo.png'),
                      Container(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    child: Text(data.aboutEmail,
                        style: Theme.of(context).textTheme.bodyText1),
                    onTap: () async {
                      if (await canLaunch('mailto:info@roy-Board.com')) {
                        await launch('mailto:info@roy-Board.com');
                      } else {
                        throw 'Could not launch info@roy-Board.com';
                      }
                    },
                  ),
                ],
...
class _TitleAndDescriptionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        Text(
          data.instruction_title!=null? data.instruction_title:'جاري جلب المعلومات من السيرفر',
        ...
        Text(
          data.instruction_desc!=null? data.instruction_desc:'جاري جلب المعلومات من السيرفر',
