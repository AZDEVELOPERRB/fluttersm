  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
                '  يتم الشراء من داخل التطبيق لضمان الجودة وارجاع البضاعة '
                    ' التي ليست جيدة وان وقت التسليم هو من يوم واحد الى  '
                    '3 ايام'
              ...
              child: InkWell(
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: <BoxShadow>[
                        BoxShadow(
                            color: RoyalBoardColors.mainColorWithBlack.withOpacity(0.6),
                    ...
                    child: Row(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Icon(Icons.payment, color: RoyalBoardColors.white),
                        const SizedBox(
