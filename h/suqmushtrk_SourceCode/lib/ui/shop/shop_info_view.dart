...
import 'package:RoyalBoard_Common_sooq/provider/rating/shop_rating_provider.dart';
...
import 'package:RoyalBoard_Common_sooq/ui/shop/address_tile_view.dart';
import 'package:RoyalBoard_Common_sooq/ui/shop/contact_us_tile_view.dart';
import 'package:RoyalBoard_Common_sooq/ui/shop/customer_review_list_item.dart';
                        ...
                        Text(
                          ...
                          style: Theme.of(context).textTheme.subtitle1.copyWith(
                              color: widget.shopInfo.priceLevel ==
                                          RoyalBoardConst.PRICE_LOW ||
                                      widget.shopInfo.priceLevel ==
                                          RoyalBoardConst.PRICE_MEDIUM ||
                                      widget.shopInfo.priceLevel ==
                                          RoyalBoardConst.PRICE_HIGH
                                  ? RoyalBoardColors.priceLevelColor
    ...
    if (widget.shopInfo != null) {
      return Column(
        ...
        children: <Widget>[
          ...
          Text(
            Utils.getString(context, 'تخصص المتجر : ') +
                widget.shopInfo.specialist,
            style:
            Theme.of(context).textTheme.bodyText1.copyWith(height: 1.4),
          ),
          _s,
            ...
            Text(
              Utils.getString(context, 'المناطق المشمولة في التوصيل : ') +
                  widget.shopInfo.deliver,
              style:
              Theme.of(context).textTheme.bodyText1.copyWith(height: 1.4),
            ),
          _s,
          Text(
            Utils.getString(context, ' منتجات حصرية : ') +
                widget.shopInfo.ex_product,
            style:
            Theme.of(context).textTheme.bodyText1.copyWith(height: 1.4),
          ),
          _s,
          ...
          Text(
            Utils.getString(context, 'اقل مبلغ للمبيعات : ') +
                widget.shopInfo.mini_money,
            style:
            Theme.of(context).textTheme.bodyText1.copyWith(height: 1.4),
          ), _s,
          Text(
            Utils.getString(context, '  ايام العطل : ') +
                widget.shopInfo.holiday,
            style:
            Theme.of(context).textTheme.bodyText1.copyWith(height: 1.4),
          ),
          // Text(
