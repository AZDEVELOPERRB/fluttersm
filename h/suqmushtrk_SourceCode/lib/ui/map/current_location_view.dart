...
import 'package:RoyalBoard_Common_sooq/viewobject/holder/map_pin_call_back_holder.dart';
...
class _LocationState extends State<CurrentLocationWidget> {
  ...
  dynamic _handleTap(
    ...
    String _tmpLat =
        _latlng != null ? _latlng.latitude.toString() : RoyalBoardConfig.lat;
    String _tmpLng =
        _latlng != null ? _latlng.longitude.toString() : RoyalBoardConfig.lng;
    ...
    final dynamic result = await Navigator.pushNamed(context, RoutePaths.mapPin,
        arguments: MapPinIntentHolder(
            flag: RoyalBoardConst.PIN_MAP, mapLat: _tmpLat, mapLng: _tmpLng));
              ...
              children: <Widget>[
                ...
                //   )
                  ...
                  _MapViewWidget(
                    mapController: mapController,
                    latlng: LatLng(
                        double.parse(RoyalBoardConfig.lat), double.parse(RoyalBoardConfig.lng)),
                    handleTap: _handleTap,
                    zoomLevel: zoomLevel,
                  )
    ...
    return Container(
      ...
      child: InkWell(
        child: Container(
          ...
          child: Icon(
            Icons.gps_fixed,
            color: RoyalBoardColors.iconColor,
