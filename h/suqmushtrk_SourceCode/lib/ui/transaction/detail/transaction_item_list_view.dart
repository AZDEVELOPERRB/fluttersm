...
import 'package:RoyalBoard_Common_sooq/provider/transaction/transaction_detail_provider.dart';
import 'package:RoyalBoard_Common_sooq/provider/transaction/transaction_status_provider.dart';
...
import 'package:RoyalBoard_Common_sooq/ui/transaction/detail/transaction_item_view.dart';
                ...
                RefreshIndicator(
                  child: CustomScrollView(
                      ...
                      slivers: <Widget>[
                        ...
                        if (widget.transaction.pickAtShop == RoyalBoardConst.ONE)
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      children: <Widget>[
        ...
        _dividerWidget,
        if (transaction.pickAtShop == RoyalBoardConst.ZERO)
          Column(
            children: <Widget>[
              const SizedBox(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .caption
                          .copyWith(color: RoyalBoardColors.black),
                    ),
                  ),
                ),
              ],
...
class _TransactionNoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String one_price='${double.parse(transaction.totalItemAmount)/double.parse(transaction.totalItemCount)}';
    ...
    return Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            _dividerWidget,
            if (transaction.pickAtShop == RoyalBoardConst.ONE)
              _TransactionNoTextWidget(
                transationInfoText:
            ...
            _TransactionNoTextWidget(
              transationInfoText:
              '${transaction.currencySymbol} ${Utils.getPriceFormat(one_price)}',
              title:
              'سعر المنتج للقطعة الواحدة :',
            ),
