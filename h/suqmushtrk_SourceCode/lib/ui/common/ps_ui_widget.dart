...
import 'package:RoyalBoard_Common_sooq/ui/common/ps_square_progress_widget.dart';
import 'package:RoyalBoard_Common_sooq/viewobject/default_icon.dart';
...
class PsNetworkImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (defaultPhoto.imgPath == '') {
      ...
      // print(
      //     'tag : $photoKey${RoyalBoardConfig.RoyalBoardImagesUrl}${defaultPhoto.imgPath}');
      final String fullImagePath =
          '${RoyalBoardConfig.RoyalBoardImagesUrl}${defaultPhoto.imgPath}';
      final String thumbnailImagePath =
          '${RoyalBoardConfig.RoyalBoardThumbsUrl}${defaultPhoto.imgPath}';
      return PsHero(
        ...
        child: GestureDetector(
          ...
          child: OptimizedCacheImage(
            placeholder: (BuildContext context, String url) {
              if (RoyalBoardConfig.USE_THUMBNAIL_AS_PLACEHOLDER) {
...
class PsNetworkImageWithUrl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (imagePath == '') {
      ...
      final String fullImagePath = '${RoyalBoardConfig.RoyalBoardImagesUrl}$imagePath';
      final String thumbnailImagePath =
          '${RoyalBoardConfig.RoyalBoardThumbsUrl}$imagePath';
...
class PsNetworkIconImageLittleRadius extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (defaultIcon.imgPath == '') {
      ...
      final String fullImagePath =
          '${RoyalBoardConfig.RoyalBoardImagesUrl}${defaultIcon.imgPath}';
      final String thumbnailImagePath =
          '${RoyalBoardConfig.RoyalBoardThumbsUrl}${defaultIcon.imgPath}';
      if (photoKey == '') {
        return GestureDetector(
            onTap: onTap,
            child: ClipRRect(
        ...
        return GestureDetector(
          ...
          child: Hero(
              tag:
                  '$photoKey${RoyalBoardConfig.RoyalBoardImagesUrl}${defaultIcon.imgPath}',
              child: ClipRRect(
                borderRadius: BorderRadius.circular(PsDimens.space8),
                child: OptimizedCacheImage(
                  placeholder: (BuildContext context, String url) {
