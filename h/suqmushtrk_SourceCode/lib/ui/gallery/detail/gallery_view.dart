...
import 'package:RoyalBoard_Common_sooq/provider/gallery/gallery_provider.dart';
import 'package:RoyalBoard_Common_sooq/repository/gallery_repository.dart';
import 'package:RoyalBoard_Common_sooq/ui/common/base/ps_widget_with_appbar_no_app_bar_title.dart';
        ...
        if (provider.galleryList != null &&
          ...
          return Stack(
            children: <Widget>[
              ...
              //   child: Icon(Icons.clear,color: RoyalBoardColors.white))),
