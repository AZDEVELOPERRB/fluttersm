...
class ProductDetailView_fromurl extends StatefulWidget {
  const ProductDetailView_fromurl(
...
class _ProductDetailState extends State<ProductDetailView_fromurl>
...
class __HeaderBoxWidgetState extends State<_HeaderBoxWidget> {
  ...
  TextEditingController cod=new TextEditingController();
  @override
  Widget build(BuildContext context) {
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: new OutlineInputBorder(
                            ...
                            hintText: 'رمز التخفيض المرسل',
                          hintStyle: TextStyle(
                            color: Colors.pink,

                          ),

                          suffixIcon:isloadserver==true?Padding(
                            padding: const EdgeInsets.all(8.0),
                            ...
                            onTap: ()async{
                              ...
                              if(cod.text==''){
                                ...
                                print('dfhsdrhasdgwseag${message}');

                                if(message=='they_same'){
                                  Fluttertoast.showToast(
                                      msg:
                                      'لايمكن التصويت لنفسك',
                                      toastLength: Toast.LENGTH_SHORT,
                                      gravity: ToastGravity.BOTTOM,
                                      timeInSecForIosWeb: 1,
                                      backgroundColor:Colors.red,
...
class __AddToBasketAndBuyButtonWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    void _showDrawer(bool isBuyButtonType) {
      ...
      Fluttertoast.showToast(
          msg:
          'يجب ان تنتبه اذا اردت السعر المخفض يلزم وجود بطاقة العبور',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          timeInSecForIosWeb: 1,
          backgroundColor: Colors.green,
