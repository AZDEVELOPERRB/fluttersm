...
import 'package:RoyalBoard_Common_sooq/constant/names_action.dart';
...
import 'package:RoyalBoard_Common_sooq/provider/basket/helper/checkout_calculation_helper.dart';
import 'package:RoyalBoard_Common_sooq/provider/history/history_provider.dart';
import 'package:RoyalBoard_Common_sooq/provider/product/favourite_product_provider.dart';
import 'package:RoyalBoard_Common_sooq/provider/product/product_provider.dart';
import 'package:RoyalBoard_Common_sooq/provider/product/touch_count_provider.dart';
...
import 'package:RoyalBoard_Common_sooq/ui/common/base/ps_widget_with_multi_provider.dart';
...
import 'package:RoyalBoard_Common_sooq/ui/common/ps_back_button_with_circle_bg_widget.dart';
import 'package:RoyalBoard_Common_sooq/ui/common/ps_button_widget.dart';
import 'package:RoyalBoard_Common_sooq/ui/common/ps_expansion_tile.dart';
import 'package:RoyalBoard_Common_sooq/ui/common/ps_hero.dart';
import 'package:RoyalBoard_Common_sooq/ui/common/ps_toast.dart';
...
import 'package:RoyalBoard_Common_sooq/ui/product/detail/views/attributes_item_view.dart';
import 'package:RoyalBoard_Common_sooq/ui/product/detail/views/color_list_item_view.dart';
import 'package:RoyalBoard_Common_sooq/utils/utils.dart';
import 'package:RoyalBoard_Common_sooq/viewobject/add_on.dart';
import 'package:RoyalBoard_Common_sooq/complaiment/productComp.dart';
import 'package:RoyalBoard_Common_sooq/viewobject/basket.dart';
import 'package:RoyalBoard_Common_sooq/viewobject/basket_selected_add_on.dart';
import 'package:RoyalBoard_Common_sooq/viewobject/basket_selected_attribute.dart';
...
import 'package:RoyalBoard_Common_sooq/viewobject/holder/favourite_parameter_holder.dart';
...
class _ProductDetailState extends State<ProductDetailView>
  ...
  checkshuf(){
    ...
    if(reaction==false){setState(() {reaction=true;});} else {setState(() {reaction=false;});
      Future.delayed(Duration(seconds: 3)).then((value) {setState(() {reaction=true;});});}
  }
  ...
  lateloading()async{
    await Future.delayed(Duration(seconds: 60)).then((value){
      endloading();
    });
  }
  @override
              ...
              ChangeNotifierProvider<TouchCountProvider>(
                ...
                create: (BuildContext context) {
                  ...
                  TouchCountParameterHolder(
                      ...
                      typeName: RoyalBoardConst.FILTERING_TYPE_NAME_PRODUCT,
                      userId: loginUserId,
                  ...
                  children: <Widget>[
                    CustomScrollView(slivers: <Widget>[
                      SliverAppBar(
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            color:
                                            RoyalBoardColors.black.withAlpha(200),
                                          ),
                                          child: Align(
                                            alignment: Alignment.center,
                                            child: Text(
                        ...
                        backgroundColor: RoyalBoardColors.mainColorWithBlack,
                        ...
                        flexibleSpace: Stack(
                          children: [
                            ...
                            reaction==true?Container():        Container(
                              ...
                              child: Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Text('${hnames[0]['name']} ${hnames[0]['des']}',style: TextStyle(color: Colors.white)),
                                  // child: Center(
                                  //
                                  //   child: DecoratedBox(
                                  //     decoration: const BoxDecoration(color: Colors.black45,
                                  ...
                                  //               children: <Widget>[
                                  //                 Container(
                                  //                     child:     Text('${i['name']} ${i['des']}',style: TextStyle(color: Colors.white),)
                                  //                 )
                                  //               ],
                                  //             );
                                  //
                                    ...
                                    child: RaisedButton(
                                      onPressed: ()async{
                                        ShopParameterHolder _shop_i=     ShopParameterHolder()
                                            .getShopbyreferal();
                                        _shop_i.shop_i=widget.product.shop.shop_i;
                                        Navigator.push(context, MaterialPageRoute(
                                          builder: (ctx){
                                            return  SearchedMarkets(
                                              ...
                                              shpoi: widget.product.shop.shop_i,
                                            );
                                          }
                                        ));
                                      ...
                                      child:Row(
                                        children: [
                                          ...
                                          Text('${widget.product.shop.name}',style:TextStyle(color:Colors.white)),
                                          SizedBox(width: 5,),
...
Future getrestshare()async{
  var timenow=await NTP.now();
 DateTime _dtnet=DateTime.parse("${timenow}");
  var mar = {
    'product_id': widget.product.id,
    'user_id':widget.psValueHolder.loginUserId,
    'u_time':'${_dtnet}',
    'bday':'${_dtnet.subtract(Duration(hours:24))}'

  };
  String ur = '${RoyalBoardConfig
      .RoyalBoardAppUrl}rest/users/get_res_shares/api_key/${RoyalBoardConfig
...
return message;
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.product != null &&
      ...
      return
        ...
        if (provider.psValueHolder.loginUserId == null ||
          ...
          provider.getUser(widget.psValueHolder.loginUserId);
        } else {
    ...
    Row(
      children: [
        Text('عدد المشاركات المطلوبة :'),
        Text('${widget.product.share_count}',style: TextStyle(color: Colors.red,),)
      ],
    ),
      if(widget.psValueHolder.loginUserId!=''&&widget.psValueHolder.loginUserId!=null)  Row(
        children: [
          Text('عدد آخر مشاركات منجزة :'),
          FutureBuilder(
            future:getrestshare() ,
            ...
            builder: (ctx ,d){
              if(d.hasData){
                if(d.data['msg']=='yess'){
                  return    Text('${d.data['data']['share_point']}',style: TextStyle(color: Colors.red,),);
                }
                else {
                  return    Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Text('لايوجد',style: TextStyle(color: Colors.red,),)
                    ],
                  );
          ...
          child:Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 4,),
                Text('استخدم بطاقة العبور لتخفيض مباشر 100%',style:TextStyle(color:Colors.white)),
              ],
            ),
          ),
        )
    ...
    // ),
    // color: RoyalBoardColors.baseLightColor,
    // child: Padding(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                      ...
                      child: (widget.productDetail != null &&
                        ...
                        decoration: BoxDecoration(
                            border:
                            Border.all(color: RoyalBoardColors.mainColor),
                            shape: BoxShape.circle),
                        child: Icon(Icons.favorite_border,
                            color: RoyalBoardColors.mainColor),
                      )
                ...
                if (widget.productDetail.productDetail.data.isAvailable == '1')
                  Text(
                    ...
                    style: Theme.of(context)
                        .textTheme
                        .bodyText2
                        .copyWith(color: RoyalBoardColors.mainDarkColor),
                  )
                else
                  Container(),
              ],
    ...
    if (widget.product != null && widget.product.unitPrice != null) {
      return Row(
        ...
        children: <Widget>[
          Container(
            ...
            child: Column(
              mainAxisSize: MainAxisSize.max,
              children: <Widget>[
                // if (widget.product.isDiscount == RoyalBoardConst.ONE)
                //   PsHero(
                  ...
                  child: Material(
                      ...
                      child: Text(
                        ...
                        style: Theme.of(context)
                            .textTheme
                            .subtitle1
                            .copyWith(color: Utils.isLightMode(context)?RoyalBoardColors.mainColor:RoyalBoardColors.white),
                      )),
                ),
                //here the secondprice
                Text('${widget.product.currencySymbol} ${widget.product.second_price}', style: Theme.of(context)
        .textTheme
        .subtitle1
        .copyWith(color:Colors.pink),),
          ...
          if (widget.product.isDiscount == RoyalBoardConst.ONE)Container()
            // Card(
            //   elevation: 0,
            //   color: RoyalBoardColors.discountColor,
            //   shape: const BeveledRectangleBorder(
...
getdataruning();
  ...
  getdataruning()async{
    ...
    var timenow=await NTP.now();
   DateTime _dtnet=DateTime.parse("${timenow}");
    DateTime Bday=_dtnet.subtract(Duration(hours: 24));
    var mar = {
      'user_id': widget.psValueHolder.loginUserId,
      'product_id': widget.product.id,
    ...
    String ur = '${RoyalBoardConfig
        .RoyalBoardAppUrl}rest/users/VoiteTimer/api_key/${RoyalBoardConfig
        .RoyalBoardServerLanucher}';


    var response = await http.post(ur, body: mar);
    var message = jsonDecode(response.body)['message'];
    if(message['msg']=='voite'){
      DateTime Ctime=DateTime.parse('${message['data']['ctime']}');
      if(Ctime.isAfter(Bday)){
        var dif=Ctime.difference(Bday).inHours;
        var difminutes=Ctime.difference(Bday).inMinutes;
        var min=difminutes-dif*60;
    ...
    else if(message['msg']=='not_voiter'){
setState(() {
  isminshare=true;
});
    }
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> by_check_card(bool isBuyButtonType) async {
      ...
      Future <bool> check_cross_Card()async {
        var timenow=await NTP.now();
        DateTime _dtnet=DateTime.parse("${timenow}");
        print('faskfhaskjh${widget.psValueHolder.loginUserId}');
        var mar = {
          'user_id': widget.psValueHolder.loginUserId,
          'product_id': widget.product.id,
          'now': '${_dtnet.subtract(Duration(hours: 24))}'
        ...
        String ur = '${RoyalBoardConfig
            .RoyalBoardAppUrl}rest/users/croos_card_buy/api_key/${RoyalBoardConfig
            .RoyalBoardServerLanucher}';


        var response = await http.post(ur, body: mar);
        var message = jsonDecode(response.body)['message'];
        _ProductDetailState().endloading();
      print('messagea${message}');
      if(message['msg']=='used'){
        Fluttertoast.showToast(
            msg:
           'لقد تم استخدام بطاقة من بطاقاتك وتبقى لك  ${message['rest']}',
      ...
      bool crosscard=await check_cross_Card() ;
      crosscard==true&&widget.product.second_price!=0&&widget.product.second_price!='0'&&widget.product.second_price!=null?   basket = Basket(
          id: id,
          productId: widget.product.id,
          ...
          basketPrice:widget.product.second_price,
  ...
  if (isBuyButtonType) {
    ...
    Future<void> addToBasketAndBuyClickEvent(bool isBuyButtonType) async {
      ...
      Future <bool> check_cross_Card()async {
        ...
        String ur = '${RoyalBoardConfig
            .RoyalBoardAppUrl}rest/users/check_cross_Card/api_key/${RoyalBoardConfig
            .RoyalBoardServerLanucher}';


        var response = await http.post(ur, body: mar);
        var message = jsonDecode(response.body)['message'];
        print('fghfddfgdf${message}');
        if(message['msg']=='has_permission'){
          return true;
        }
        if(message['msg']=='not_enough_voites'){
          Fluttertoast.showToast(
              msg:
              'لم يكتمل عدد المصوتين بعد',
              toastLength: Toast.LENGTH_SHORT,
              gravity: ToastGravity.BOTTOM,
        ...
        if(message['msg']=='no_time'){
          Fluttertoast.showToast(
              msg:
              ' لقد انتهت مدة التصويت',
              toastLength: Toast.LENGTH_SHORT,
              gravity: ToastGravity.BOTTOM,
              timeInSecForIosWeb: 1,
              backgroundColor:Colors.red,
        ...
        if(message['msg']=='no_permission'){
          Fluttertoast.showToast(
              msg:
              'لا يوجد ترخيص لامتلاك السعر المخفض',
              toastLength: Toast.LENGTH_SHORT,
              gravity: ToastGravity.BOTTOM,
              timeInSecForIosWeb: 1,
              backgroundColor:Colors.red,
      ...
      if (isBuyButtonType) {
        bool crosscard = await check_cross_Card();
        crosscard == true && widget.product.second_price != 0 &&
            widget.product.second_price != '0' &&
            widget.product.second_price != null ? basket = Basket(
            id: id,
            productId: widget.product.id,
            qty: qty ?? widget.product.minimumOrder,
            shopId: widget.product.shop.id,
    ...
    Future <bool> check_boughter()async {
      var timenow=await NTP.now();
      DateTime _dtnet=DateTime.parse("${timenow}");
      print('faskfhaskjh${widget.psValueHolder.loginUserId}');
      var mar = {
    ...
    void  use_cross_card(bool isBuyButtonType) {
            ...
            return Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text('يرجى الملاحظة عند الضغط على اي من الازرار سنقوم بالاتصال بالخوادم التابعة للشركة وفحص جميع تراخيصك في الحصول على السعر المخفض لذا يرجى الانتظار'),
                ),
                Divider(height: PsDimens.space20, color: RoyalBoardColors.mainColor),
                Flexible(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          PSButtonWithIconWidget(
                              ...
                              width: double.infinity,
                              titleText: 'مشاركة المنتج وجمع فريق الآن',
                              onPressed:()async{
                                _ProductDetailState().loading(context);
                                var timenow=await NTP.now();
                                DateTime _dtnet=DateTime.parse("${timenow}");
                                var mars = {
                                  'product_id': widget.product.id,
                                ...
                                String urlof = '${RoyalBoardConfig
                                    .RoyalBoardAppUrl}rest/users/check_share_permissions/api_key/${RoyalBoardConfig
                                    .RoyalBoardServerLanucher}';
                                var first_response= await http.post(urlof,body: mars);
                                var json=jsonDecode(first_response.body)['message'];
                          ...
                          PSButtonWithIconWidget(
                            ...
                            onPressed:()async{
                              ...
                              Fluttertoast.showToast(msg: 'تم النسخ', toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.BOTTOM, timeInSecForIosWeb: 2, backgroundColor:Colors.green, textColor:Colors.white);


                            },),
                          const SizedBox(
                            height: PsDimens.space12,
                          ), use_check_card_class(
                ...
                Container(
                  ...
                  child: RaisedButton(
                      ...
                      child:SingleChildScrollView(
                        ...
                        child:  Row(
                          children: [
                            isminshare==false?minshare==0?Text('جاري الفحص ...',style: TextStyle(color:Colors.white,fontSize: 12),):
                            Row(
                              children: [
                                Text(' ${second_share} :',style: TextStyle(color:Colors.red,fontSize: 12),),
                                Text(' ${minutes} :',style: TextStyle(color:Colors.white,fontSize: 12),),  SizedBox(width: 2,),
                                Text(' ${minshare} ',style: TextStyle(color:Colors.white,fontSize: 12),),

                                Text('ساعة' ,style: TextStyle(color:Colors.black,fontSize: 12),),


                              ],
                            )
                                :Text('لاتمتلك وقت حالياً',style: TextStyle(color: Colors.white,fontSize: 12),),
                            Icon(Icons.timer_sharp,color: Colors.white,size: 13,)
                          ],
                        ),
                      ),
                      onPressed: (){
            ...
            Row(
              ...
              children: [
                ...
                RaisedButton(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(25)),
                  color: Colors.black,
                  child: Text('تقديم بلاغ',style: TextStyle(color: Colors.white),),
                  onPressed: ()=>Navigator.push(context, MaterialPageRoute(
                      builder: (ctx)=>ProductComplaiment(widget.psValueHolder.loginUserId,widget.product.id)
                  )),
                ),
                      ...
                      Expanded(
                          child: RaisedButton(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text('${widget.product.second_price} ${widget.product.currencySymbol}',style: TextStyle(fontSize: 14,color:Colors.white),),
                                Text('شراء مشترك مع الاصدقاء',style: TextStyle(color:Colors.white,fontSize: 14),)
                              ],
                            ),
                            onPressed: () async {
                              await _ProductDetailState().loading(context);

                              if(widget.psValueHolder.loginUserId==""||widget.psValueHolder.loginUserId==null){
                                _ProductDetailState().endloading();
                                Fluttertoast.showToast(
                                    msg:
                                    'لا يحق لك الشراء دون انشاء حساب كامل',
                                    toastLength: Toast.LENGTH_SHORT,
                                    gravity: ToastGravity.BOTTOM,
                                    timeInSecForIosWeb: 2,
                                    backgroundColor:Colors.red,
                              ...
                              if(await check_boughter()==true){
                                _ProductDetailState().endloading();
                                Fluttertoast.showToast(
                                    msg:
                                    'مبروك لقد استحقيت السعر المخفض',
                                    toastLength: Toast.LENGTH_SHORT,
                                    gravity: ToastGravity.BOTTOM,
                                    timeInSecForIosWeb: 2,
                                    backgroundColor:Colors.green,
                      ...
                      Expanded(
                          child:RaisedButton(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text('${widget.product.unitPrice} ${widget.product.currencySymbol}',style: TextStyle(color:Colors.white),),
                                Text('شراء مباشر',style: TextStyle(color:Colors.white),)
                              ],
                            ),
                            onPressed: () async {
                              if (widget.basketProvider.basketList.data
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: (widget.product.isDiscount == RoyalBoardConst.ONE)
                      ? Row(
                    children: <Widget>[
                      Text(
                        widget.price != null
                ...
                Text(
                  ...
                  style: Theme.of(context)
                      .textTheme
                      .caption
                      .copyWith(color: RoyalBoardColors.grey),
                ),
              if(widget.product.second_price!=null&&widget.product.second_price!=0&&widget.product.second_price!='0')  Text(
                  'اذا كنت تمتلك بطاقة العبور سوف يكون السعر ${widget.product.second_price}${widget.product.currencySymbol}',
                  overflow: TextOverflow.ellipsis,
                  maxLines: 1,
                  style: Theme.of(context)
                      .textTheme
...
class _IconAndTextWidgetState extends State<_IconAndTextWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget _addIconWidget = IconButton(
        ...
        icon: Icon(Icons.add_circle, color: RoyalBoardColors.mainColor),
        onPressed: () {
          onUpdateItemCount(1);
        });
    ...
    final Widget _removeIconWidget = IconButton(
        iconSize: PsDimens.space32,
        icon: Icon(Icons.remove_circle, color: RoyalBoardColors.grey),
        onPressed: () {
          onUpdateItemCount(2);
        });
    return Container(
        ...
        children: <Widget>[
          ...
          Center(
            child: Container(
              ...
              alignment: Alignment.center,
              decoration: BoxDecoration(
                  border: Border.all(color: RoyalBoardColors.mainDividerColor)),
              padding: const EdgeInsets.only(
...
class use_check_card_class extends StatefulWidget {
  const use_check_card_class({
    Key key,
  ...
  @override
  use_check_card_class_widget createState() =>
      use_check_card_class_widget();
}

class use_check_card_class_widget
    extends State<use_check_card_class> {
  @override
  Widget build(BuildContext context) {
    if (widget.isBuyButtonType) {
      return Container(
        ...
        child: PSButtonWithIconWidget(
            ...
            width: double.infinity,
            titleText: 'استخدام بطاقة العبور',
            onPressed: () async {
              _ProductDetailState().loading(context);
              // Future.delayed(Duration(seconds:3)).then((value) =>  _ProductDetailState().endloading());
              ...
              Container(
                ...
                child: ScaleTransition(
                  ...
                  child: FloatingActionButton(
                    ...
                    backgroundColor: RoyalBoardColors.mainColor,
                    mini: true,
                    child: Icon(widget.icons[index], color: RoyalBoardColors.white),
                    onPressed: () async {
                      print(index);
                      if (await canLaunch(index == 0
                          ? messengerUrl
