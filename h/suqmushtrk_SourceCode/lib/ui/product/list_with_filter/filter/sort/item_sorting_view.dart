          ...
          children: <Widget>[
            GestureDetector(
              child: SortingView(
                  ...
                  checkImage:
                      _searchProductProvider.productParameterHolder.orderBy ==
                              RoyalBoardConst.FILTERING__ADDED_DATE
              ...
              onTap: () {
                ...
                _searchProductProvider.productParameterHolder.orderType =
                    RoyalBoardConst.FILTERING__DESC;
            ...
            GestureDetector(
              child: SortingView(
                  ...
                  checkImage:
                      _searchProductProvider.productParameterHolder.orderBy ==
                              RoyalBoardConst.FILTERING__TRENDING
                          ? 'assets/images/baseline_check_green_24.png'
                          : ''),
              onTap: () {
                print('sort by popular product');
                _searchProductProvider.productParameterHolder.orderBy =
                    RoyalBoardConst.FILTERING_TRENDING;
                _searchProductProvider.productParameterHolder.orderType =
                    RoyalBoardConst.FILTERING__DESC;
            ...
            GestureDetector(
              child: SortingView(
                  ...
                  checkImage:
                      _searchProductProvider.productParameterHolder.orderBy ==
                                  RoyalBoardConst.FILTERING_PRICE &&
                              _searchProductProvider
                                      .productParameterHolder.orderType ==
                                  RoyalBoardConst.FILTERING__ASC
                          ? 'assets/images/baseline_check_green_24.png'
                          : ''),
              onTap: () {
