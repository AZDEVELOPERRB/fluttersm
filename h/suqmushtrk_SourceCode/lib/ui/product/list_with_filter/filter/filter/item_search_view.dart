...
import 'package:RoyalBoard_Common_sooq/ui/common/ps_special_check_text_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return PsWidgetWithAppBar<SearchProductProvider>(
        ...
        onProviderReady: (SearchProductProvider provider) {
          ...
          if (widget.productParameterHolder.isDiscount == RoyalBoardConst.ONE) {
            _searchProductProvider.isSwitchedDiscountPrice = true;
          } else {
            _searchProductProvider.isSwitchedDiscountPrice = false;
          }
          if (widget.productParameterHolder.isFeatured == RoyalBoardConst.ONE) {
...
class _ChangeRatingColor extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Color defaultBackgroundColor = RoyalBoardColors.backgroundColor;
    return Container(
      width: MediaQuery.of(context).size.width / 5.5,
      height: PsDimens.space104,
      decoration: BoxDecoration(
        color: checkColor ? defaultBackgroundColor : RoyalBoardColors.mainColor,
      ),
      child: Center(
        child: Column(
          ...
          children: <Widget>[
            Icon(
              Icons.star,
              color: checkColor ? RoyalBoardColors.iconColor : RoyalBoardColors.white,
            ),
            const SizedBox(
