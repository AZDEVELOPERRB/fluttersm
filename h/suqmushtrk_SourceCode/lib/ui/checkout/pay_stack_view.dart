...
import 'package:RoyalBoard_Common_sooq/ui/common/base/ps_widget_with_appbar_with_no_provider.dart';
...
import 'package:RoyalBoard_Common_sooq/ui/common/ps_credit_card_from_for_pay_stack.dart';
    ...
    if (userLoginProvider.user != null && userLoginProvider.user.data != null) {
      ...
      final PsResource<TransactionHeader> _apiStatus =
          await transactionSubmitProvider.postTransactionSubmit(
              ...
              '',
              RoyalBoardConst.ONE,
              isClickPickUpButton == true ? RoyalBoardConst.ONE : RoyalBoardConst.ZERO,
              deliveryPickUpDate,
              deliveryPickUpTime,
              basketProvider.checkoutCalculationHelper.shippingCost.toString(),
            ...
            child: SingleChildScrollView(
              ...
              children: <Widget>[
                CreditCardWidget(
                  ...
                  animationDuration: RoyalBoardConfig.animation_duration,
                ),
