...
import 'package:RoyalBoard_Common_sooq/ui/common/ps_dropdown_base_with_controller_widget.dart';
...
import 'package:RoyalBoard_Common_sooq/viewobject/holder/profile_update_view_holder.dart';
...
class _Checkout1ViewState extends State<Checkout1View> {
  ...
  DateTime dateTime =
      DateTime.now().add(const Duration(minutes: RoyalBoardConfig.defaultOrderTime));
  String latestDate;
  ...
  Widget build(BuildContext context) {
    ...
    if (userProvider.selectedRadioBtnName == RoyalBoardConst.ORDER_TIME_ASAP) {
                      ...
                      Row(
                        children: [
                          Padding(
                            ...
                            child: Text('اكتب مكان التوصيل اليك'),
                          ),
                        ],
                      ),
                      Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(color: RoyalBoardColors.mainDividerColor),
                          ),
                          child: TextField(
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  Radio<String>(
                    ...
                    groupValue: RoyalBoardConst.ORDER_TIME_ASAP,
                    onChanged: (String name) {
                      widget.updateOrderByData(RoyalBoardConst.ORDER_TIME_ASAP);
                      final DateTime dateTime = DateTime.now().add(
                          const Duration(minutes: RoyalBoardConfig.defaultOrderTime));
                  ...
                  Expanded(
                    child: Text(
                      Utils.getString(context, 'checkout1__asap') +
                          ' (' +
                          RoyalBoardConfig.defaultOrderTime.toString() +
                          'mins)',
              ...
              Row(
                children: <Widget>[
                  Radio<String>(
                    value: widget.userProvider.selectedRadioBtnName,
                    groupValue: RoyalBoardConst.ORDER_TIME_SCHEDULE,
                    onChanged: (String name) async {
                      widget.updateOrderByData(RoyalBoardConst.ORDER_TIME_SCHEDULE);
        ...
        Container(
            ...
            child: TextField(
                enabled: widget.userProvider.selectedRadioBtnName ==
                    RoyalBoardConst.ORDER_TIME_SCHEDULE,
                ...
                style: Theme.of(context).textTheme.bodyText2.copyWith(
                    color: widget.userProvider.selectedRadioBtnName ==
                            RoyalBoardConst.ORDER_TIME_ASAP
                        ? RoyalBoardColors.textPrimaryLightColor
        ...
        children: <Widget>[
          ...
          SizedBox(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: RoyalBoardColors.backgroundColor,
                border: Border.all(color: RoyalBoardColors.backgroundColor),
                  ...
                  Expanded(
                    child: PSButtonWidget(
                      ...
                      textColor: widget.isClickDeliveryButton
                          ? RoyalBoardColors.white
                          : RoyalBoardColors.black,
                      width: double.infinity,
