...
class _CheckoutContainerViewState extends State<CheckoutContainerView> {
  ...
  Widget build(BuildContext context) {
    ...
    _RoyalBoardApiService = Provider.of<RoyalBoardApiService>(context);
            ...
            showDialog<dynamic>(
                ...
                builder: (BuildContext context) {
                  return ConfirmDialogView(
                      ...
                      onAgreeTap: () async {
                        print('fsakufhkasfh');
                        //this is checkout server application
                        Navigator.pop(context);
                        final dynamic returnData =
  ...
  Widget build(BuildContext context) {
    StatelessWidget checkSecondCircle() {
      return Icon(
        ...
        color: viewNo != 1 ? RoyalBoardColors.mainColor : RoyalBoardColors.grey,
      );
    }
    ...
    StatelessWidget checkThirdCircle() {
      return Icon(
        MaterialCommunityIcons.checkbox_blank_circle_outline,
        size: PsDimens.space28,
        color: viewNo == 3 ? RoyalBoardColors.mainColor : RoyalBoardColors.grey,
      );
    }
                          ...
                          Text(
                              ...
                              style: viewNo == 1
                                  ...
                                  : Theme.of(context)
                                      ...
                                      .copyWith(
                                          color:
                                              RoyalBoardColors.textPrimaryDarkColor)),
                        ],
                      ),
                      Expanded(
                        child: Container(
