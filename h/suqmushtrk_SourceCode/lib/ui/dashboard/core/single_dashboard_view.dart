...
import 'package:RoyalBoard_Common_sooq/ui/dashboard/home/main_single_dashboard_view.dart';
              ...
              builder:
                ...
                return ListView(padding: EdgeInsets.zero, children: <Widget>[
                  ...
                  _DrawerMenuWidget(
                      ...
                      index: RoyalBoardConst.REQUEST_CODE__MENU_COLLECTION_FRAGMENT,
                      onTap: (String title, int index) {
                        Navigator.pop(context);
                        updateSelectedIndexWithAnimation(title, index);
                      }),
                  ...
                  _DrawerMenuWidget(
                      ...
                      index: RoyalBoardConst.REQUEST_CODE__MENU_LANGUAGE_FRAGMENT,
                      onTap: (String title, int index) {
                        Navigator.pop(context);
          ...
          onProfileSelected: (String userId) {
            ...
            //     RoyalBoardConst.REQUEST_CODE__DASHBOARD_VERIFY_EMAIL_FRAGMENT)
            {
              updateUserCurrentIndex(
                  ...
                  RoyalBoardConst.REQUEST_CODE__DASHBOARD_USER_PROFILE_FRAGMENT,
                  userId);
              // updateCurrentIndex(RoyalBoardConst.REQUEST_CODE__DASHBOARD_USER_PROFILE_FRAGMENT);
            }
          },
          onSignInSelected: () {
            if (currentIndex ==
...
class _DrawerHeaderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DrawerHeader(
      ...
      decoration: BoxDecoration(color: RoyalBoardColors.mainColor),
    );
  }
}
