      ...
      body: Stack(
        ...
        children: <Widget>[
          Column(children: <Widget>[
            Container(
              ...
              child: Padding(
                ...
                child: RaisedButton(
                  ...
                  color: Colors.blue,
                  child: Text('فرز',style: TextStyle(color: Colors.white),),
                  onPressed:  () async {
            ...
            //         color: RoyalBoardColors.baseDarkColor,
  ...
  Widget getWidget(int i, int currentIndex) {
    ...
    if (_catId == RoyalBoardConst.specialCollection) {
      ...
      widgetList[widgetIndex] =  SubCatMP(category:widget.categoryList[widgetIndex],shopid: widget.shopId,
        key: _viewkeys[widgetIndex],  subcat: '',flag: callFromDBIndexList[widgetIndex] ?? false,isfeatered: false,isOffer: '0',
