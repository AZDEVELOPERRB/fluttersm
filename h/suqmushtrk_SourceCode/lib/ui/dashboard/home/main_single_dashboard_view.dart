...
import 'package:RoyalBoard_Common_sooq/provider/category/trending_category_provider.dart';
import 'package:RoyalBoard_Common_sooq/provider/product/search_product_provider.dart';
import 'package:RoyalBoard_Common_sooq/provider/productcollection/product_collection_provider.dart';
...
import 'package:RoyalBoard_Common_sooq/ui/dashboard/home/home_tabbar_slider.dart';
              ...
              create: (BuildContext context) {
                final ProductCollectionProvider provider =
                    ProductCollectionProvider(
                        repo: repo3,
                        limit: RoyalBoardConfig.COLLECTION_PRODUCT_LOADING_LIMIT);
    ...
    return Consumer<CategoryProvider>(
      builder: (BuildContext context, CategoryProvider categoryProvider,
        ...
        if(categoryProvider.isLoading){
          return Container(child: Center(child: Text('جاري التحميل'),),);
        }
        ...
        if (RoyalBoardConfig.showHome) {
          _tmpList.insert(
              i,
              Category(
                  id: RoyalBoardConst.mainMenu,
                  name: Utils.getString(context, 'dashboard__main_menu')));
          i++;
        }

        if (RoyalBoardConfig.showSpecialCollections) {
          _tmpList.insert(
              i,
              Category(
                  id: RoyalBoardConst.specialCollection,
            ...
            Expanded(
              child: Text(widget.headerName,
                  style: Theme.of(context).textTheme.headline6.copyWith(
                      ...
                      color: RoyalBoardColors.textPrimaryDarkColor)),
            ),
            Text(
