...
import 'package:RoyalBoard_Common_sooq/provider/product/discount_product_provider.dart';
...
import 'package:RoyalBoard_Common_sooq/provider/shop/trending_shop_provider.dart';
...
import 'package:RoyalBoard_Common_sooq/ui/category/item/category_horizontal_list_item.dart';
...
import 'package:RoyalBoard_Common_sooq/ui/map/home_location_view.dart';
import 'package:RoyalBoard_Common_sooq/ui/product/item/product_horizontal_list_item.dart';
import 'package:RoyalBoard_Common_sooq/ui/shop_list/item/shop_horizontal_list_item.dart';
...
import 'package:RoyalBoard_Common_sooq/Offers/Customers_Offers.dart';
        ...
        providers: <SingleChildWidget>[
          ChangeNotifierProvider<NewShopProvider>(
              ...
              create: (BuildContext context) {
                newShopProvider = NewShopProvider(
                    repo: shopRepository, limit: RoyalBoardConfig.SHOP_LOADING_LIMIT);
          ...
          ChangeNotifierProvider<CategoryProvider>(
              ...
              create: (BuildContext context) {
                _categoryProvider ??= CategoryProvider(
                    repo: repo1,
                    psValueHolder: valueHolder,
                    limit: RoyalBoardConfig.CATEGORY_LOADING_LIMIT);
          ...
          ChangeNotifierProvider<SearchProductProvider>(
              ...
              create: (BuildContext context) {
                final SearchProductProvider provider = SearchProductProvider(
                    repo: repo2, limit: RoyalBoardConfig.LATEST_PRODUCT_LOADING_LIMIT);
          ...
          ChangeNotifierProvider<DiscountProductProvider>(
              ...
              create: (BuildContext context) {
                _discountProductProvider = DiscountProductProvider(
                    repo: repo2,
                    limit: RoyalBoardConfig.DISCOUNT_PRODUCT_LOADING_LIMIT);
          ...
          ChangeNotifierProvider<TrendingProductProvider>(
              ...
              create: (BuildContext context) {
                _trendingProductProvider = TrendingProductProvider(
                    repo: repo2,
                    limit: RoyalBoardConfig.TRENDING_PRODUCT_LOADING_LIMIT);
...
class __HomeNewShopHorizontalListWidgetState
  ...
  void checkConnection() {
    Utils.checkInternetConnectivity().then((bool onValue) {
      ...
      if (isConnectedToInternet && RoyalBoardConst.SHOW_ADMOB) {
        setState(() {});
      }
    });
  }
        ...
        builder: (BuildContext context, NewShopProvider newShopProvider,
          ...
          return AnimatedBuilder(
              ...
              child: (newShopProvider.shopList.data != null &&
                      newShopProvider.shopList.data.isNotEmpty)?Container()
              //here nearby
          ...
          return AnimatedBuilder(
            ...
            child: (productProvider.productList.data != null &&
                ...
                ? Column(
                    ...
                    //       ),
                    //       child: RaisedButton(
                    //         child: Text('العروض المميزة'),
                    //         color: RoyalBoardColors.backgroundColor,
                    //         onPressed: (){
                    //           Navigator.push(context,MaterialPageRoute(
                    //               builder: (context)=>Custom_Offers(
                    //                 appBarTitle: "العروض المميزة",
                              ...
                              return CategoryHorizontalListItem(
                                ...
                                onTap: () {
                                  ...
                                  categoryProvider.postTouchCount(
                                      touchCountParameterHolder.toMap());
                                  if (RoyalBoardConfig.isShowSubCategory) {
                                    Navigator.pushNamed(
            ...
            Expanded(
              child: Text(widget.headerName,
                  style: Theme.of(context)
                      .textTheme
                      .headline5
                      .copyWith(color: RoyalBoardColors.textPrimaryDarkColor)),
            ),
            Text(
