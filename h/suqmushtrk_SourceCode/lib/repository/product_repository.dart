...
import 'package:RoyalBoard_Common_sooq/db/product_collection_dao.dart';
...
import 'package:RoyalBoard_Common_sooq/viewobject/favourite_product.dart';
import 'package:RoyalBoard_Common_sooq/viewobject/product_collection.dart';
...
import 'package:RoyalBoard_Common_sooq/viewobject/product_map.dart';

class ProductRepository extends PsRepository {
  ProductRepository(
      {@required RoyalBoardApiService RoyalBoardApiService, @required ProductDao productDao}) {
  ...
  Future<dynamic> getProductList(
    ...
    if (isConnectedToInternet) {
      final PsResource<List<Product>> _resource =
          await _RoyalBoardApiService.getProductList(holder.toMap(), limit, offset);
  ...
  Future<dynamic> getProductDetail(
    ...
    if (isConnectedToInternet) {
      final PsResource<Product> _resource =
          await _RoyalBoardApiService.getProductDetail(productId, loginUserId);
  ...
  Future<PsResource<List<DownloadProduct>>> postDownloadProductList(
    ...
    final PsResource<List<DownloadProduct>> _resource =
        await _RoyalBoardApiService.postDownloadProductList(jsonMap);
    if (_resource.status == PsStatus.SUCCESS) {
      return _resource;
    } else {
  ...
  Future<dynamic> getAllFavouritesList(
    ...
    if (isConnectedToInternet) {
      final PsResource<List<Product>> _resource =
          await _RoyalBoardApiService.getFavouritesList(loginUserId, limit, offset);
  ...
  Future<PsResource<Product>> postFavourite(Map<dynamic, dynamic> jsonMap,
      ...
      {bool isLoadFromServer = true}) async {
    final PsResource<Product> _resource =
        await _RoyalBoardApiService.postFavourite(jsonMap);
    if (_resource.status == PsStatus.SUCCESS) {
      return _resource;
    } else {
  ...
  Future<dynamic> getAllproductListByCollectionId(
    ...
    // Server Call
    if (isConnectedToInternet) {
      final PsResource<List<Product>> _resource = await _RoyalBoardApiService
