...
import 'package:RoyalBoard_Common_sooq/viewobject/shop_map.dart';
import 'package:sembast/sembast.dart';

class ShopRepository extends PsRepository {
  ShopRepository(
      {@required RoyalBoardApiService RoyalBoardApiService, @required ShopDao shopDao}) {
  ...
  Future<dynamic> devgetShopList(
    ...
    if (isConnectedToInternet) {
      ...
      await _RoyalBoardApiService.getShopListforcats(holder.toMap(), limit, offset);
  ...
  Future<dynamic> getShopList(
    ...
    if (isConnectedToInternet) {
      final PsResource<List<Shop>> _resource =
          await _RoyalBoardApiService.getShopList(holder.toMap(), limit, offset);
  ...
  //   if (isConnectedToInternet) {
  //     final PsResource<List<Shop>> _resource =
  //         await _RoyalBoardApiService.getShopListByTagId(
  //       limit,
  //       offset,
  //       tagId,
  //     );
  ...
  //   if (isConnectedToInternet) {
  //     final PsResource<List<Shop>> _resource =
  //         await _RoyalBoardApiService.getShopListByTagId(limit, offset, tagId);
