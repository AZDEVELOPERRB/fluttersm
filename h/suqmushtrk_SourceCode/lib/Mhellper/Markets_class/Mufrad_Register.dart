...
class Mufrad_Register extends StatefulWidget {
  var userid;

  Mufrad_Register(this.userid);

  @override
  _Mufrad_RegisterState createState() => _Mufrad_RegisterState();
}

class _Mufrad_RegisterState extends State<Mufrad_Register> {
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Center(child: Text(' تجار  المفرد',style: TextStyle(fontSize:19,color: Colors.white),)),
                          ...
                          Container(
                            ...
                            child:     Padding(
                              ...
                              child: TextFormField(
                                decoration: InputDecoration(
                                  labelText: "اقل مبلغ للبيع بالدولار",
                                  labelStyle: blue_s
                                  ,border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(25)
                                ),
