import 'package:RoyalBoard_Common_sooq/viewobject/Item_color.dart';
import 'package:RoyalBoard_Common_sooq/viewobject/category.dart';
import 'package:RoyalBoard_Common_sooq/viewobject/customized_header.dart';
...
class Product extends PsObject<Product> {
  ...
  Product fromMap(dynamic dynamicData) {
    if (dynamicData != null) {
      return Product(
          ...
          dynamic_link: dynamicData['dynamic_link'],
          share_count: dynamicData['share_count'],
          ...
          is_offer: dynamicData['is_offer'],
          originalPrice: dynamicData['original_price'],
          unitPrice: dynamicData['unit_price'],
          second_price: dynamicData['second_price'],
          Firm_prices: dynamicData['Firm_prices'],
  ...
  Map<String, dynamic> toMap(dynamic object) {
    if (object != null) {
      ...
      data['dynamic_link'] = object.dynamic_link;
      ...
      data['is_offer'] = object.is_offer;
      data['original_price'] = object.originalPrice;
      data['unit_price'] = object.unitPrice;
      data['second_price'] = object.second_price;
      data['Firm_prices'] = object.Firm_prices;
