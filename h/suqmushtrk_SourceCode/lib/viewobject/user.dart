...
class User extends PsObject<User> {
  ...
  User fromMap(dynamic dynamicData) {
    if (dynamicData != null) {
      return User(
        ...
        ua: dynamicData['ua'],
        rolletua: dynamicData['rolletua'],
        all_ua: dynamicData['all_ua'],
        shad: dynamicData['shad'],

        ref_id: dynamicData['ref_id'],
        is_gift_given: dynamicData['is_gift_given'],
        hour_clicked: dynamicData['hour_clicked'],
        cross_card: dynamicData['cross_card'],
        first_gift: dynamicData['first_gift'],
  ...
  Map<String, dynamic> toMap(User object) {
    if (object != null) {
      ...
      data['ua'] = object.ua;
      data['rolletua'] = object.rolletua;
      data['all_ua'] = object.all_ua;
      data['shad'] = object.shad;
      data['ref_id'] = object.ref_id;
      data['is_gift_given'] = object.is_gift_given;
      data['hour_clicked'] = object.hour_clicked;
      data['cross_card'] = object.cross_card;
      data['first_gift'] = object.first_gift;
