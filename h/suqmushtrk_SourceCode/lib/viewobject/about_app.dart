...
class AboutApp extends PsObject<AboutApp> {
  AboutApp({
    ...
    this.instruction_title,
    this.instruction_desc,
    this.aboutEmail,
    this.aboutPhone,
    this.aboutWebsite,
    this.adsOn,
  ...
  AboutApp fromMap(dynamic dynamicData) {
    if (dynamicData != null) {
      return AboutApp(
        ...
        instruction_title: dynamicData['instruction_title'],
        instruction_desc: dynamicData['instruction_desc'],
  ...
  Map<String, dynamic> toMap(dynamic object) {
    if (object != null) {
      ...
      data['instruction_title'] = object.instruction_title;
      data['instruction_desc'] = object.instruction_desc;
