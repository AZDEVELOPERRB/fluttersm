...
import 'package:RoyalBoard_Common_sooq/viewobject/rating_detail.dart';
import 'package:RoyalBoard_Common_sooq/viewobject/shop_branch.dart';
...
class Shop extends PsObject<Shop> {
  ...
  Shop fromMap(dynamic dynamicData) {
    if (dynamicData != null) {
      return Shop(
          ...
          jomla:dynamicData['jomla'],
          is_verified:dynamicData['is_verified'],
          shop_i:dynamicData['shop_i'],
          description: dynamicData['description'],
          ex_product: dynamicData['ex_product'],
          deliver: dynamicData['deliver'],
          specialist: dynamicData['specialist'],
          ...
          mini_money: dynamicData['mini_money'],
          holiday: dynamicData['holiday'],
  ...
  Map<String, dynamic> toMap(dynamic object) {
    if (object != null) {
      ...
      data['jomla'] = object.jomla;
      data['is_verified'] = object.is_verified;
      data['shop_i'] = object.shop_i;
      data['description'] = object.description;
      data['ex_product'] = object.ex_product;
      data['deliver'] = object.deliver;
      data['specialist'] = object.specialist;
      ...
      data['mini_money'] = object.mini_money;
      data['holiday'] = object.holiday;
