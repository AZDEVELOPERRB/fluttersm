...
class ShopProvider extends PsProvider {
  ...
  Future<dynamic> loadShopListByKey(
    ...
    print('dfjhdfhdfshsdhf${shopParameterHolder.toMap()}');
  ...
  Future<dynamic> devloadShopListByKey(
      ShopParameterHolder shopParameterHolder) async {
    print('jhdfhdfhdfafh${shopParameterHolder.toMap()}');
    isConnectedToInternet = await Utils.checkInternetConnectivity();
    isLoading = true;
    await _repo.devgetShopList(shopListStream, isConnectedToInternet, limit,
        offset, PsStatus.PROGRESS_LOADING, shopParameterHolder);
  }
