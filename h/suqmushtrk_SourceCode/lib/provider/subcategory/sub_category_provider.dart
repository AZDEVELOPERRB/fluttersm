...
class SubCategoryProvider extends PsProvider {
  ...
  Future<dynamic> loadAllSubCategoryList(String categoryId,{String shopid}) async {
    isLoading = true;
    isConnectedToInternet = await Utils.checkInternetConnectivity();
    await _repo.getAllSubCategoryListByCategoryId(subCategoryListStream,
        isConnectedToInternet, PsStatus.PROGRESS_LOADING, categoryId,shopid: shopid!=null?shopid
    :"noshopid");
  }
