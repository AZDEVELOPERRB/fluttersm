...
class TransactionHeaderProvider extends PsProvider {
  ...
  Future<dynamic> postTransactionSubmit(
    ...
    final TransactionSubmitMap newPost = TransactionSubmitMap(
      ...
      isCod: isCod == RoyalBoardConst.ONE ? RoyalBoardConst.ONE : RoyalBoardConst.ZERO,
      isPickUp: isPickUp == RoyalBoardConst.ONE ? RoyalBoardConst.ONE : RoyalBoardConst.ZERO,
      isPaypal: isPaypal == RoyalBoardConst.ONE ? RoyalBoardConst.ONE : RoyalBoardConst.ZERO,
      isStripe: isStripe == RoyalBoardConst.ONE ? RoyalBoardConst.ONE : RoyalBoardConst.ZERO,
      isBank: isBank == RoyalBoardConst.ONE ? RoyalBoardConst.ONE : RoyalBoardConst.ZERO,
      isRazor: isRazor == RoyalBoardConst.ONE ? RoyalBoardConst.ONE : RoyalBoardConst.ZERO,
      isPaystack: isPaystack == RoyalBoardConst.ONE ? RoyalBoardConst.ONE : RoyalBoardConst.ZERO,
      razorId: razorId,
      ...
      transStatusId: RoyalBoardConst.THREE, // 3 = completed
